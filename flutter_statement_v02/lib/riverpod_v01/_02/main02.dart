...
import 'package:flutter_statement_v02/riverpod_v01/_02/fruit.dart';
...
// 2. 리버팟을 사용하기 위해서 소비자 ConsumerWidget으로 변경해야 한다.
            ...
            children: [
              ...
              ElevatedButton(
                onPressed: () {
                  ...
                  // 머신을 동작 시켜야 한다.
                  // read() 메서드는 데이터를 한번 들고 오기도 하지만 창고 자체에 접근 시킬 수 있다.
                  // 창고 자체에 접근 했다.
                  FruitStore fruitStore = ref.read(fruitProvider.notifier);
                  fruitStore.changeDate("딸기");
                },
