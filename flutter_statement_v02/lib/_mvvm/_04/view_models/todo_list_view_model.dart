...
// 1. 뷰 모델을 사용하고 있다.
// 2. 뷰 모델에 날개를 달아 주자! (riverpod 상태 관리 기능 추가)
...
class TodoListViewModel extends Notifier<List<TodoItem>> {
  ...
  void addItem(String title) {
    // state.add <-- 원래 사용하고있는 객체에 접근해서 추가했더니
    // 위젯이 변경이 안되었다. 하지만 새로운 객체를 만들어서 할당하니
    // 위젯 변경이 일어났다.
